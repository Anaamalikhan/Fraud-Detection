...
# STEP A: Create RAW dataset (simulate big messy data)
...
# STEP B: Clean dataset (duplicates + missing values)
...
# STEP C: Train KMeans + Save Model
...
# STEP D: Load model if exists else train
...
if st.button("Predict Risk"):
    ...
    # suspicious cluster = cluster with highest centroid amount
